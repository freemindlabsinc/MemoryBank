...
openai_gpt4_key = "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"
#Inferenec function
...
title = """<h1 align="center">🔥GPT Streaming Chat</h1>"""
...
def create_chat_tab():
   with gr.Blocks(css = """#col_container { margin-left: auto; margin-right: auto;} #chatbot {height: 520px; overflow: auto;}""",
       ...
       with gr.Column(elem_id = "col_container"):
           ...
           with gr.Row():
               #openai_gpt4_key = gr.Textbox(label="OpenAI GPT4 Key", value="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", type="password", placeholder="sk..", 
